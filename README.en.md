...
Version 1.9.2 hardens the paths where data arrives from outside the server:
...
If you are running 1.9.1 or earlier, updating is recommended.
...
DARK VPN Backhaul Manager is an independent management layer and is not
