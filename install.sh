#!/usr/bin/env bash
# ==============================================================================
#  DARK VPN · BACKHAUL - installer
#  curl -fsSL https://raw.githubusercontent.com/darktunnelmika/dark-backhaul/main/install.sh | bash
# ==============================================================================
set -u

RAW="https://raw.githubusercontent.com/darktunnelmika/dark-backhaul/main/dark-backhaul.sh"
...
echo
printf '  %sDARK VPN · BACKHAUL%s  installer\n' "$C" "$N"
echo
...
grep -q 'DARKVPN-BACKHAUL-SCRIPT' "$tmp" || { bad "downloaded file is not the manager"; exit 1; }
